    ...
    renderDetailedSection(title, resultData, type) {
        ...
        switch(type) {
            case 'vehicle':
                ...
                confidence = resultData.confidence.vehicle;
                processingTime = resultData.processingTime.vehicle;
                break;
            case 'plate':
                imageSrc = resultData.croppedImages.plate;
                predicted = resultData.predictions.plateClass;
                actual = resultData.actual.plateClass;
                confidence = resultData.confidence.plate;
                processingTime = resultData.processingTime.plateDetection;
                break;
            case 'ocr':
                imageSrc = resultData.croppedImages.plate;
                predicted = resultData.predictions.plateNumber;
                actual = resultData.actual.plateNumber;
                confidence = resultData.confidence.ocr;
                processingTime = resultData.processingTime.plateRecognition;
                break;
        }
